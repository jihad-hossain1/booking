        ...
        return createPortal(
            ...
            >
                <div
                    ...
                    className={`fixed left-[50%] top-[50%] z-50 w-full translate-x-[-50%] translate-y-[-50%] gap-4 border border-gray-200 bg-white p-1 shadow-lg duration-200 sm:rounded-lg ${className}`}
                    {...props}
                >
                    {children}
                </div>
